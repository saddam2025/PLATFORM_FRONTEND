...
export default function ExamGradesPage() {
  ...
  useEffect(() => {
    let active = true;
    api.get('/quizzes/me/exam-grades')
  ...
  return <div dir="rtl" className="mx-auto max-w-5xl space-y-6">
    <div><h1 className="text-2xl font-bold text-ink-900">درجات الاختبارات</h1><p className="mt-1 text-sm text-ink-500">سجل كل محاولاتك في الاختبارات والمحاضرات.</p></div>
